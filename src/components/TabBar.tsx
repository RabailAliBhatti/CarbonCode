        ...
        <div className="flex items-center bg-editor-sidebar border-b border-editor-border overflow-x-auto">
            ...
            `}
                    >
                        {/* File Icon */}
                        {tab.language === 'java' ? (
                            <span className="w-4 h-4 text-xs font-bold text-orange-400 flex items-center justify-center shrink-0" title="Java">J</span>
                        ) : (
                            <span className="w-4 h-4 text-xs font-bold text-blue-400 flex items-center justify-center shrink-0" title="C++">C++</span>
                        )}
