    ...
    return (
        <div className="h-full w-full overflow-y-auto bg-gradient-to-br from-editor-bg via-editor-sidebar to-editor-bg">
            <div className="min-h-full flex items-center justify-center py-12">
                <div className="max-w-3xl w-full mx-auto px-6 text-center animate-fade-in">
                    {/* Logo */}
                    <div className="mb-8">
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-4 mb-12">
                        ...
                        <button
                            onClick={onOpenFile}
                            className="flex items-center justify-center gap-3 px-6 py-3 bg-editor-sidebar hover:bg-editor-border text-text-bright border border-editor-border rounded-xl font-medium transition-all hover:shadow-lg active:scale-95 min-w-[140px]"
                        >
                            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="w-px h-10 bg-editor-border hidden sm:block mx-2" />

                        <button
                            onClick={onStartCoding}
                            className="flex items-center justify-center gap-2 px-4 py-3 text-text-secondary hover:text-text-bright transition-all"
                        >
                            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="bg-editor-sidebar/50 rounded-xl p-6 border border-editor-border shadow-sm max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 text-sm">
                            <div className="flex items-center justify-between gap-2 px-3 py-2 bg-editor-bg rounded-lg border border-editor-border/50">
                                <span className="text-text-secondary">New File</span>
                                <kbd className="px-2 py-1 bg-editor-border/50 rounded text-text-bright text-xs font-mono font-bold shadow-sm">Ctrl+N</kbd>
                            </div>
                            <div className="flex items-center justify-between gap-2 px-3 py-2 bg-editor-bg rounded-lg border border-editor-border/50">
                                <span className="text-text-secondary">Open File</span>
                                <kbd className="px-2 py-1 bg-editor-border/50 rounded text-text-bright text-xs font-mono font-bold shadow-sm">Ctrl+O</kbd>
                            </div>
                            <div className="flex items-center justify-between gap-2 px-3 py-2 bg-editor-bg rounded-lg border border-editor-border/50">
                                <span className="text-text-secondary">Save</span>
                                <kbd className="px-2 py-1 bg-editor-border/50 rounded text-text-bright text-xs font-mono font-bold shadow-sm">Ctrl+S</kbd>
                            </div>
                            <div className="flex items-center justify-between gap-2 px-3 py-2 bg-editor-bg rounded-lg border border-editor-border/50">
                                <span className="text-text-secondary">Save As</span>
                                <kbd className="px-2 py-1 bg-editor-border/50 rounded text-text-bright text-xs font-mono font-bold shadow-sm">Ctrl+Shift+S</kbd>
                            </div>
                            <div className="flex items-center justify-between gap-2 px-3 py-2 bg-editor-bg rounded-lg border border-editor-border/50">
                                <span className="text-text-secondary">Run</span>
                                <kbd className="px-2 py-1 bg-editor-border/50 rounded text-text-bright text-xs font-mono font-bold shadow-sm">F5</kbd>
                            </div>
                            <div className="flex items-center justify-between gap-2 px-3 py-2 bg-editor-bg rounded-lg border border-editor-border/50">
                                <span className="text-text-secondary">Quit</span>
                                <kbd className="px-2 py-1 bg-editor-border/50 rounded text-text-bright text-xs font-mono font-bold shadow-sm">Ctrl+Q</kbd>
                            </div>
                        </div>
                    </div>
